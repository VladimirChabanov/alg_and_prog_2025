...
> [!WARNING]
>
> Перед выполнением этого раздела:
>
> 1. Перейдите на сайт пакета [gnuplot](https://sourceforge.net/projects/gnuplot/files/gnuplot/);
>
> 2. Скачайте и установите пакет (понадобится VPN, если нет VPN, то [отсюда](https://disk.yandex.ru/d/j-Azswcow0dSmg)). В процессе установки, поставьте галочку в пункт о добавлении пакета в `PATH`;
>
>    <p align="center"><img src="./practice_02_4_img/gnuplot.png"></p>
>
> 3. Откройте новый терминал и проверьте, что команда `gnuplot` не сообщает об ошибке;
>
> 4. Если Visual Studio открыта, перезапустите, чтобы среда обновила переменную среды `PATH`.
