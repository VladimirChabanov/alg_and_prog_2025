...
> [!CAUTION]
> Через несколько часов после публикации этой части практической работы, автор пакета [`cimg`](https://github.com/GreycLab/CImg) перезалил архивы для версии [v.3.6.5](https://github.com/GreycLab/CImg/releases/tag/v.3.6.5). От этой версии зависит сборка текущей версии пакета `matplotplusplus`.
>
> Из-за перезалива, сборка перестала работать, т.к. теперь хэш архива, который ожидает получить `vcpkg` и реальный не совпадают и `vcpkg` ругается на это.
>
> Чтобы исправить ситуацию откройте файл `"C:\tools\vcpkg\ports\cimg\portfile.cmake"` и измените в нём хэши:
>
> ```bash
> # старый
> 7a0a66cf8dfb9923be0ee576f5dc6c53a8704a92ce9b1b3b8d1a7c6b5a1d94f231fce25a813f0fb6e6afd0f75111a8efb91f3e05c57621900ef588e00bf8d06c
> # на новый
> 4580ea45df9650df82dc81f444078cfbee5a21dcef4fa59b6c2bae7d531f3bb89318814ba3bdc0ec1dea7aaab678c7e6ab12d8e61afa3492d657922d482ae5ab
> ```
>
> Вывод: не делайте перезаливы, лучше создавайте новые версии, чтобы не создавать проблемы своим пользователям.
